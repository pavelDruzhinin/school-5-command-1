            ...
            >
                <v-list-item three-line>
                    <v-list-item-content>
                        ...
                        <v-list-item-subtitle><p>[Description]: Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Ratione dicta veniam molestiae recusandae repudiandae sit, eligendi exercitationem neque
                            similique aliquam voluptatibus, culpa itaque consequatur officia magni corrupti dolorem
                            necessitatibus nostrum.</p></v-list-item-subtitle>
                    </v-list-item-content>
                </v-list-item>
                <v-card-actions>
                    <v-btn
                    ...
                    <v-card class="pt-10">
                        <v-card-text>
                            ...
                            >
                                ...
                                <v-btn color="indigo"
                                       @click="reset();dialog=false">Close
                                </v-btn>
                            </v-form>
                        </v-card-text>
                    </v-card>
